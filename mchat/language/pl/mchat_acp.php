...
$lang = array_merge($lang, array(
	...
	'MCHAT_RULES_EXPLAIN'					=> 'Tutaj wprowadź regulamin mChat. Każdy podpunkt w oddzielnej linii.<br>Ustaw 0, aby wyłączyć tą opcję. Kod HTML jest dozwolony.<br>Ta wiadomość może być przetłumaczona: edytuj klucz MCHAT_RULES_MESSAGE w pliku /ext/dmzx/mchat/language/XX/common.php',
	...
	'MCHAT_STATIC_MESSAGE_EXPLAIN'			=> 'Tutaj możesz umieścić ogłoszenie, które wyświetli się użytkownikom mChat. Kod HTML jest dozwolony.<br>Pozostaw pustą aby nic nie wyświetlać. <br>Ta wiadomość może być przetłumaczona: edytuj klucz MCHAT_STATIC_MESSAGE w /ext/dmzx/mchat/language/XX/mchat.php',
