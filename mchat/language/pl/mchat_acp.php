...
$lang = array_merge($lang, [
	...
	'MCHAT_SETTINGS_LOG'					=> 'Ustawienia dziennika administratorów',
	...
	'MCHAT_RULES_EXPLAIN'					=> 'Tutaj wprowadź regulamin mChat. Każdy podpunkt w oddzielnej linii.<br>Kod HTML jest dozwolony. Pozostaw puste pole, aby nic nie wyświetlać.<br>Ta wiadomość może być przetłumaczona: edytuj klucz MCHAT_RULES_MESSAGE w pliku /ext/dmzx/mchat/language/XX/common.php',
	...
	'MCHAT_INDEX_HEIGHT_EXPLAIN'			=> '<em>Wybierz pomiędzy 50 a 1000 pikseli. Domyślnie to 250.</em>',
	'MCHAT_TOP_OF_FORUM'					=> 'Góra',
	'MCHAT_BOTTOM_OF_FORUM'					=> 'Dół',
	'MCHAT_REFRESH'							=> 'Częstotliwość odświeżania',
	'MCHAT_REFRESH_EXPLAIN'					=> 'Po ilu sekundach nastąpi automatyczne odświeżanie.<br><em>Wybierz pomiędzy 2 a 3600 sekund. Domyślnie to 10.</em>',
	...
	'MCHAT_PRUNE_NUM_EXPLAIN'				=> 'Jeśli wybierzesz ’wiadomości’, wskazana liczba wiadomości zostanie zachowana. Jeśli wybierzesz ’godzin’, ’dni’ lub ’tygodni’, wszystkie wiadomości starsze niż wskazany okres zostaną usunięte.',
	...
	'MCHAT_MESSAGE_NUM_CUSTOM_EXPLAIN'		=> '<em>Domyślnie to 10 wiadomości.</em>',
	'MCHAT_MESSAGE_NUM_INDEX'				=> 'Liczba wiadomości mChat na stronie głównej forum',
	'MCHAT_MESSAGE_NUM_INDEX_EXPLAIN'		=> '<em>Domyślnie to 10 wiadomości.</em>',
	'MCHAT_MESSAGE_NUM_ARCHIVE'				=> 'Liczba wiadomości w Archiwum',
	'MCHAT_MESSAGE_NUM_ARCHIVE_EXPLAIN'		=> '<em>Wybierz pomiędzy 10 a 100 wiadomości. Domyślnie to 25.</em>',
	...
	'MCHAT_FLOOD_TIME_EXPLAIN'				=> 'Liczba sekund, jaką musi odczekać użytkownik, aby wysłać następną wiadomość.<br><em>Wybierz pomiędzy 0 a 3600 sekund (1 godzina). Domyślnie to 0 sekund. Ustaw 0, aby wyłączyć limit.</em>',
	'MCHAT_FLOOD_MESSAGES'					=> 'Limit wiadomości blokady antyspamowej',
	'MCHAT_FLOOD_MESSAGES_EXPLAIN'			=> 'Liczba wiadomości, jaką może napisać użytkownik po kolei, zanim zostanie zablokowana możliwość pisania.<br><em>Wybierz pomiędzy 0 a 100 wiadomości. Domyślnie to 0. Ustaw 0, aby wyłączyć limit.</em>',
	...
	'MCHAT_MAX_MESSAGE_LENGTH_EXPLAIN'		=> 'Maksymalna liczba znaków, jaką można użyć w jednej wiadomości.<br><em>Domyślnie to 500 znaków. Ustaw 0, aby wyłączyć.</em>',
	'MCHAT_MAX_INPUT_HEIGHT'				=> 'Maksymalna wysokość pola wprowadzania wiadomości',
	'MCHAT_MAX_INPUT_HEIGHT_EXPLAIN'		=> 'Pole wprowadzania wiadomości nie będzie wyższe niż podana liczba pikseli.<br><em>Wybierz pomiędzy 0 a 1000 pikseli. Domyślnie to 150. Ustaw 0, aby wyłączyć.</em>',
	'MCHAT_CUSTOM_PAGE'						=> 'Pokaż stronę główną mChat',
	'MCHAT_CUSTOM_HEIGHT'					=> 'Wysokość strony głównej mChat',
	'MCHAT_CUSTOM_HEIGHT_EXPLAIN'			=> '<em>Wybierz pomiędzy 50 a 1000 pikseli. Domyślnie to 350.</em>',
	...
	'MCHAT_STATIC_MESSAGE_EXPLAIN'			=> 'Tutaj możesz umieścić ogłoszenie, które wyświetli się użytkownikom mChat.<br>Kod HTML jest dozwolony. Pozostaw puste pole, aby nic nie wyświetlać.<br>Ta wiadomość może być przetłumaczona: edytuj klucz MCHAT_STATIC_MESSAGE w /ext/dmzx/mchat/language/XX/mchat.php',
	...
	'MCHAT_OVERRIDE_MIN_POST_CHARS_EXPLAIN'	=> 'Zaznacz TAK, aby włączyć minimalną liczbę znaków używanych w wiadomościach mChat.',
	'MCHAT_LOG_ENABLED'						=> 'Zapisz zmiany w dzienniku administratorów',
	'MCHAT_LOG_ENABLED_EXPLAIN'				=> 'W dzienniku są zapisane informacje o edytowanych, usuniętych, skasowanych i wyczyszczonych wiadomościach.',
	
	'MCHAT_POSTS_AUTH_CHECK'				=> 'Sprawdź ustawienia użytkownika',
	'MCHAT_POSTS_AUTH_CHECK_EXPLAIN'		=> 'Zaznacz TAK, aby użytkownik bez uprawnień nie generował powiadomień o nowym poście/zalogowaniu.',
	...
	'MCHAT_RETAIN_MESSAGES'							=> '%1$s i wiadomości mChat',
	'MCHAT_DELETE_MESSAGES'							=> '%1$s i wiadomości mChat',
	...
	'TOO_LARGE_MCHAT_FLOOD_MESSAGES'		=> 'Wprowadzona liczba wiadomości zabezpieczenia antyspmawego jest za duża.',
	...
	'TOO_LARGE_MCHAT_MAX_INPUT_HEIGHT'		=> 'Maksymalna wysokość okna jest za duża.',
	...
	'TOO_SMALL_MCHAT_MESSAGE_NUM_INDEX'		=> 'Liczba wiadomości do wyświetlania na stronie głównej forum jest za mała.',
	'TOO_LARGE_MCHAT_MESSAGE_NUM_INDEX'		=> 'Liczba wiadomości do wyświetlania na stronie głównej forum jest za duża.',
