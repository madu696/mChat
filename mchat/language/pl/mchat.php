...
$lang = array_merge($lang, [
	...
	'MCHAT_LIKE'					=> 'Lubię tę wiadomość',
	'MCHAT_LIKES'					=> 'Lubię tę wiadomość',
	...
	'MCHAT_SOUND_ON'				=> 'Dźwięk powiadomień jest włączony',
	'MCHAT_SOUND_OFF'				=> 'Dźwięk powiadomień jest wyłączony',
	'MCHAT_ENTER'					=> 'Alternatywna zmiana poprzez kombinację Ctrl/Cmd + Enter',	
	'MCHAT_ENTER_SUBMIT'			=> 'Przycisk Enter wysyła wiadomość',
	'MCHAT_ENTER_LINEBREAK'			=> 'Przycisk Enter dodaje nową linię',
	'MCHAT_COLLAPSE_TITLE'			=> 'Przełącz widoczność mChat',
	'MCHAT_WHO_IS_REFRESH_EXPLAIN'	=> 'Odśwież co <strong>%1$d</strong> sekund',
	'MCHAT_MINUTES_AGO'				=> [
		0 => 'chwilę temu',
		1 => '%1$d minutę temu',
		2 => '%1$d minut(y) temu',
